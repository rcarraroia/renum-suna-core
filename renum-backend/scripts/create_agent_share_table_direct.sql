-- Script para criar a tabela de compartilhamento de agentes no Supabase
-- Versão para execução direta no SQL Editor do Supabase

-- Criar extensão uuid-ossp se ainda não existir
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Criar tabela de compartilhamento de agentes
...
ALTER TABLE public.agent_shares ADD CONSTRAINT agent_shares_agent_user_unique UNIQUE (agent_id, user_id);
