...
def print_manual_instructions():
    ...
    print(f"{Colors.CYAN}   cd \"Suna frontend\" && npm run dev{Colors.ENDC}\n")

    print(f"{Colors.BOLD}3. Start Backend (in a new terminal):{Colors.ENDC}")
    print(f"{Colors.CYAN}   cd \"Suna backend\" && uv run api.py{Colors.ENDC}\n")

    print(f"{Colors.BOLD}4. Start Background Worker (in a new terminal):{Colors.ENDC}")
    print(
        f"{Colors.CYAN}   cd \"Suna backend\" && uv run dramatiq run_agent_background{Colors.ENDC}\n"
    )
